...
import com.smw.license.schlichtherle.xml.GenericCertificate;
import com.smw.license.schlichtherle.xml.PersistenceService;
import com.smw.license.schlichtherle.xml.PersistenceServiceException;
...
public class PrivacyGuard
{
    ...
    throws Exception
  {
    ...
    System.out.println(">>>>>>>>>>>>>>>>"+localByteArrayOutputStream.size());
  ...
  public GenericCertificate key2cert(byte[] paramArrayOfByte)
    throws Exception
  {
	  System.out.println(">>>>>>>>>>>>"+new String(paramArrayOfByte,"UTF-8").length());
