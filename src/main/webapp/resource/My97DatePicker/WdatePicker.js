...
(function() {
	...
	function I(G, _) {
		...
		function E(K, J) {
			...
			C();
			function C() {
				//获取当前网址，如： http://localhost:8080/index.jsp
			    ...
			    var pojUrl=localhostPaht+projectName;
			   /* var pojUrl=localhostPaht;
			    alert(pojUrl);*/
			    var _ = J.getRealLang();  
				K.lang = _.name;
				K.skin = J.skin;
				var $ = [
						...
						"</script><script src="/*, A*/, pojUrl+"/resource/My97DatePicker/lang/", _.name,
					...
					if (D[C].name == J.skin)
						$
								.push("<link rel=\"stylesheet\" type=\"text/css\" href=\""
										/*+ A*/
										+ pojUrl+"/resource/My97DatePicker/skin/"
										+ D[C].name
										+ "/datepicker.css\" charset=\""
										+ D[C].charset + "\"/>");
				/*$.push("<script src=\"" + A + "calendar.js\"></script>");*/
				$.push("<script src=\""+pojUrl+"/resource/My97DatePicker/calendar.js\"></script>");
				$
