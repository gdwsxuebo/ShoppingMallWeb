...
(function($){
    $.fn.dialog=function(flag,options){
        ...
        var winY = ($(window).height()- popDiv.height())/5 + $(window).scrollTop() + "px";
            ...
            scrol:function(kg){
                if(kg!="off"){
                    /*$(window).bind("scroll.popWin"+popDiv.attr("id"),function (){
                            var offsetTop = ($(window).height()- popDiv.height())/5 + $(window).scrollTop() +"px"; 
    ...
    if(scrolls){
        ...
        $(window).scroll(function (){
            var offsetTop = ($(window).height()- popDiv.height())/5 + $(window).scrollTop() +"px"; 
            popDiv.animate({top : offsetTop },{duration:10000 , queue:false });  
        });
    }
    };
