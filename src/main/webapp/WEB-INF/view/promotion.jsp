        ...
        <%@ include file="public/header.jsp"%>
            <div class="middle">
                <div class="map">
                    ...
                    <span class="mapName">促销 > 会员促销券设置</span>
                </div>
                <!--除以下content内容，其余地方均为模板，不要改动-->
                <div class="content">
                    <div class="title">
                       	<!-- 搜索 -->
                    	<form class="form-search" action="web/promotion/getPromotion" method="post" id="searchForm">
	                        <div class="search">
...
<!--查看发放范围弹窗 -->    
    <div class="shadow" id="lookSendPop">
        <div class="pop look lookSendPop">
            ...
            <div class="container">
                <div class="storeListck" id="roleGroup2"></div>
            </div>
            <div class="handle">
...
<!-- 使用范围弹窗弹窗 -->
        ...
        <div class="pop look lookUsePop">
            ...
            <div class="container">
                <div class="storeListck" id="roleGroup3">
                </div>
            </div>
            <div class="handle">
...
<!-- 添加弹窗 -->
		<form enctype="multipart/form-data" action="web/promotion/addPR"  id="signupForm1" class="form-horizontal"  method="post">
       		...
       		<div class="pop addSale">
            	...
            	<div class="overflow">
            		<div class="container">
                <div class="formList">
                    <p><span>标题</span><input type="text" name="title" id="title" onblur="isAddRepeat();"></p>
	...
	<div class="pop look lookUsePop">
		...
		<!-- 修改弹窗 -->
		<form enctype="multipart/form-data" action="web/promotion/updatePR"  id="signupForm2" class="form-horizontal"  method="post">
       		...
       		<div class="pop addSale">
                ...
                <div class="formList">
                    ...
                    <input type="text" name="title" id="title2" onblur="isEditRepeat();">
                    </p>
...
$(function (){
 ...
 function page(cuPage){
 	...
 	if(key == ""){
 		window.location.href = "web/promotion/getPromotion?pageIndex="+cuPage+"&pageSize=10";
 	}else{
 		window.location.href = "web/promotion/getPromotion?key="+key+"&pageIndex="+cuPage+"&pageSize=10";
 	}
 	if(goPage != "" && goPage != null && key == ""){
 		window.location.href = "web/promotion/getPromotion?pageIndex="+goPage+"&pageSize=10";
 	}
 	if(goPage != "" && goPage != null && key != ""){
 		window.location.href = "web/promotion/getPromotion?key="+key+"&pageIndex="+goPage+"&pageSize=10";
 	}
 }
